...
User.getJSON = async function () {
  try {
    ...
    const resNews = await fetch(`https://newsapi.org/v2/top-headlines?country=${country}&category=${category}&pageSize=${pageSize}&page=${page}&apiKey=9ddea5b4c23d41fab68d0e9779d87815`);
